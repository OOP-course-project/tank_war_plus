...
class ProtocolHandler:
    ...
    def player_pos(player, protocol):
        ...
        # 告诉其他玩家当前玩家坦克的位置发生变化
        player.send_without_self({"protocol": "player_pos", "player_data": player.game_data})
    ...
    def player_injured(player, protocol):
        ...
        # 告诉其他玩家当前玩家中子弹受伤
        # player.send_without_self({"protocol": "ser_move", "player_data": player.game_data})
        player.send_all_player({"protocol": "player_injured", "role_id": protocol.get('role_id'), "player_data": player.game_data})
    @staticmethod
    def player_die(player, protocol):
        ...
        # 告诉所有玩家该坦克死亡
        player.send_all_player({"protocol": "player_die", "role_id": protocol.get('role_id'), "player_data": player.game_data})
