    ...
    while not game_over:
            ...
            if event.type == DELAYEVENT:
                if len(enemy_tank_group) < 3:
                    if g.player.role_id == 1:
                        # 由1号玩家告知服务端有新的敌人出现
                        client.send({"protocol":"enemy_birth", "kind": 0})
        ...
        if player_tank1.life > 0:
            ...
            if key_pressed[pygame.K_w]:
                client.send({"protocol":"cli_move","dir": "up","x":player_tank1.rect.x,"y":player_tank1.rect.y})
            elif key_pressed[pygame.K_s]:
                client.send({"protocol":"cli_move","dir": "down","x":player_tank1.rect.x,"y":player_tank1.rect.y})
            elif key_pressed[pygame.K_a]:
                client.send({"protocol":"cli_move","dir": "left","x":player_tank1.rect.x,"y":player_tank1.rect.y})
            elif key_pressed[pygame.K_d]:
                client.send({"protocol":"cli_move","dir": "right","x":player_tank1.rect.x,"y":player_tank1.rect.y})
